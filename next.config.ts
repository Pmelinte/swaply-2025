      ...
      headers: [
        {
          ...
          value: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://va.vercel-scripts.com https://vercel.live https://www.paypal.com https://js.braintreegateway.com https://www.paypalobjects.com",
            ...
            "font-src 'self'",
            "connect-src 'self' https://*.supabase.co https://keaejxlwqtjjglijiplh.supabase.co/functions/v1/* https://keaejxlwqtjjglijiplh.supabase.co/rest/v1/* https://keaejxlwqtjjglijiplh.supabase.co/auth/v1/* https://keaejxlwqtjjglijiplh.supabase.co/storage/v1/* wss://keaejxlwqtjjglijiplh.supabase.co/* https://vercel.live wss://*.pusher.com https://*.pusher.com https://api-inference.huggingface.co https://router.huggingface.co https://api.groq.com https://generativelanguage.googleapis.com https://www.google-analytics.com https://*.analytics.google.com https://va.vercel-scripts.com https://api.paypal.com https://api.sandbox.paypal.com https://api.cloudinary.com https://api.x.ai",
            "frame-src 'self' https://vercel.live https://www.google.com https://maps.google.com https://www.paypal.com https://www.sandbox.paypal.com",
            "object-src 'none'",
            "base-uri 'self'",
          ].join("; "),
        },
