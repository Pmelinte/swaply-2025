      ...
      headers: [
        {
          ...
          value: [
            ...
            "frame-src 'self' https://vercel.live https://www.google.com https://maps.google.com https://www.paypal.com https://*.paypal.com https://www.sandbox.paypal.com https://*.sandbox.paypal.com",
            "object-src 'none'",
            "base-uri 'self'",
          ].join("; "),
        },
