...
export default function CategorySelect({
  ...
  // Când primim valori din AI (sau din state extern) → actualizăm intern selecțiile
  useEffect(() => {
  ...
  function handleCategoryChange(e: React.ChangeEvent<HTMLSelectElement>) {
    ...
    // Reset subcategorie dacă schimbăm categoria (opțional: setăm prima subcategorie)
    if (cat) {
