...
export function FooterNav() {
  ...
  return (
    <nav
      ...
      className="sticky bottom-0 z-20 border-t border-zinc-200 bg-white/90 pb-[env(safe-area-inset-bottom)] backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/80"
    >
        ...
        {links.map((link) => {
          ...
          return (
            <Link
              ...
              className={`relative flex min-h-11 flex-col items-center justify-center gap-1 rounded-xl px-2 py-2 transition hover:bg-zinc-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 dark:hover:bg-zinc-800 ${active ? "bg-blue-50 text-blue-700 dark:bg-blue-950/30 dark:text-blue-100" : ""}`}
            >
