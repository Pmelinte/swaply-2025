  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 px-4 py-12 text-center">
      <div className="flex justify-center">
        <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-500 to-green-600 text-white shadow-lg">
          <Wrench className="h-10 w-10" />
        </div>
      </div>
      <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50">{t("services")}</h1>
