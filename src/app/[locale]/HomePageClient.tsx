...
export default function HomePageClient({
  ...
  recentItemsSlot: React.ReactNode;
}) {
  const {
    user,
    announcements,
  ...
  return (
    <div className="space-y-8">
      ...
      {/* StatsBar and CurrentEventBanner rendered by server wrapper with Suspense */}
      {statsSlot}
      {eventSlot}
      ...
      {/* RecentItems rendered by server wrapper with Suspense */}
      {recentItemsSlot}
