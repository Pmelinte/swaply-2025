...
const SECTIONS = [
  ...
  { id: "meeting", titleKey: "safetyMeeting", textKey: "safetyMeetingText" },
  { id: "shipping", titleKey: "safetyShipping", textKey: "safetyShippingText" },
  { id: "scams", titleKey: "safetyScams", textKey: "safetyScamsText" },
  { id: "reporting", titleKey: "safetyReporting", textKey: "safetyReportingText" },
  { id: "contact", titleKey: "safetyContact", textKey: "safetyContactText" },
] as const;
...
export default function SafetyPage() {
  ...
  return (
    <div className="space-y-4">
      <SectionCard title={t("safetyTitle")} description={t("safetyLastUpdated")}>
        {/* Last updated badge */}
