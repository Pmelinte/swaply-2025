...
const SECTIONS = [
  ...
  { id: "prohibited", titleKey: "copyrightProhibited", textKey: "copyrightProhibitedText" },
  { id: "user-responsibilities", titleKey: "copyrightUserResp", textKey: "copyrightUserRespText" },
  { id: "platform-rights", titleKey: "copyrightPlatformRights", textKey: "copyrightPlatformRightsText" },
  { id: "trademark", titleKey: "copyrightTrademark", textKey: "copyrightTrademarkText" },
] as const;
...
export default function CopyrightPage() {
  ...
  return (
    <div className="space-y-4">
      <SectionCard
        title={normalizePublicLegalCopy(t("copyrightTitle"))}
        description={normalizePublicLegalCopy(t("copyrightSubtitle"))}
      >
