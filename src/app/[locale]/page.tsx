...
export default function HomePage() {
  return (
    <Suspense fallback={<SkeletonGrid count={4} />}>
      <div
        className={`${styles.home} relative left-1/2 w-[calc(100vw-1rem)] -translate-x-1/2 isolate overflow-hidden bg-gradient-to-b from-[#bdefff] via-[#f5ffe9] to-[#eaffb8] px-3 pb-28 pt-3 sm:w-[calc(100vw-2rem)] sm:px-5 sm:pb-32 lg:px-8 xl:px-10`}
      >
        <div
