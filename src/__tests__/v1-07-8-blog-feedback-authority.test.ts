...
describe("V1-07.8 Blog feedback and suggestion authority", () => {
  ...
  it("keeps retries idempotent and conflicting payloads fail closed", () => {
  ...
  it("keeps contribution rows private to their contributor", () => {
    ...
    expect(migration).toContain("revoke insert, update, delete on table public.blog_contributions from authenticated");
  });
