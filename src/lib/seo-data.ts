...
// NOTE: dbCategory values use English slugs matching the items.category column in Supabase.
export const SEO_CATEGORIES: SEOCategory[] = [
  ...
  },
  {
    slug: "fashion",
    name: "Fashion",
    dbCategory: "fashion_accessories",
