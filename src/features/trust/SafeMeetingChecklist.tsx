  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
      <div className="mb-3 flex items-center gap-2">
        ...
        <h3 className="text-lg font-bold">Checklist Întâlnire Sigură</h3>
      </div>
      ...
      {!allRequiredDone && (
        <div className="mb-3 flex items-start gap-2 rounded-lg bg-amber-50 px-3 py-2 text-sm text-amber-800 dark:bg-amber-950/30 dark:text-amber-300">
          ...
          <span>Completează toate punctele obligatorii înainte de întâlnire.</span>
        </div>
      )}
      ...
      <div className="mb-4">
        <div className="mb-1 flex justify-between text-xs text-zinc-500">
          <span>{checked.size}/{safeMeetingChecklist.length} verificări</span>
          <span>{progress}%</span>
        </div>
      ...
      {allRequiredDone && (
        <div className="mt-4 rounded-lg bg-emerald-50 px-3 py-2 text-center text-sm font-medium text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-300">
          Toate verificările obligatorii sunt complete. Întâlnire sigură!
        </div>
      )}
    </div>
  );
