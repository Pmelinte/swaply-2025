 ...
 *
 * IMPORTANT:
 * - Nu importăm ItemCreateInput / ItemUpdateInput deoarece NU sunt exportate din ../types.
 * - Contractul real al inputului e dat de Zod (validation.ts) + mapping-ul de mai jos.
 *
 * Coloane așteptate:
 * id, owner_id, title, description, category, subcategory, tags, condition,
 * location_city, location_country, approximate_value, currency,
